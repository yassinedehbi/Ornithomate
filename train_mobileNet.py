...
MYY_PATH = '/Users/akbya/Downloads/'
...
def _main(MY_PATH=MYY_PATH):
    ...
    if True:
        model.compile(optimizer=Adam(learning_rate=1e-6), loss={
        ...
        model.save_weights(log_dir + '4gen_stage_1.h5')
    ...
    if True:
        ...
        model.compile(optimizer=Adam(learning_rate=1e-7), loss={'yolo_loss': lambda y_true, y_pred: y_pred}) # recompile to apply the change
        ...
        model.save_weights(log_dir + '4gen_final.h5')
